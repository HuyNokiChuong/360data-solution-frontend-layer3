...
const GlobalFilterBar: React.FC<GlobalFilterBarProps> = ({ dashboard }) => {
    ...
    return (
        <div className="bg-[#0f172a] border-b border-white/5 px-6 py-2.5 flex items-center gap-3 overflow-visible z-[100]">
            ...
            <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <div key={widget.id} className="relative">
                        ...
                        <button
                            ...
                            className={`
                                ...
                                ${openFilterId === widget.id
                                    ...
                                    : 'bg-slate-900/50 border-white/10 text-slate-400 hover:border-indigo-500/50 hover:text-white'
                                }
                            `}
                        >
                        ...
                        {openFilterId === widget.id && (
                            <>
                                ...
                                />
                                <div className="absolute top-full left-0 mt-2 w-64 bg-slate-900 border border-indigo-500/30 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] z-[120] overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                                    <div className="px-3 py-2 border-b border-white/5 bg-slate-900/50 flex items-center justify-between">
                ...
                <button
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-dashed border-white/10 text-slate-600 hover:text-indigo-400 hover:border-indigo-500/30 transition-all"
