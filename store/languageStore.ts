...
const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        'users.column_visibility': 'Column Visibility',
        'users.reset_columns': 'Reset Columns',
        'users.min_one_column': 'At least one column must stay visible',
    ...
    vi: {
        ...
        'users.column_visibility': 'Hiển thị cột',
        'users.reset_columns': 'Khôi phục cột',
        'users.min_one_column': 'Phải giữ lại ít nhất 1 cột hiển thị',
