    ...
    return (
        ...
        >
            <div className="relative mb-8 transition-transform group-hover:scale-105 duration-500">
                ...
                <i className={`fas ${getIcon(type)} text-8xl text-slate-200 dark:text-slate-800/40 relative z-10 group-hover:text-slate-300 dark:group-hover:text-slate-700/50 transition-colors`}></i>
            ...
            <div className="max-w-[240px] space-y-3 relative z-10">
                <p className="text-slate-800/80 dark:text-white/80 font-black text-sm uppercase tracking-[0.2em] group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">
                ...
                <p className="text-slate-400 dark:text-slate-500 text-[10px] leading-relaxed group-hover:text-slate-600 dark:group-hover:text-slate-400 transition-colors">
                    Click anywhere or drag fields from the <span className="text-indigo-600 dark:text-indigo-400 font-black">Data</span> tab to start visualizing.
                </p>
            </div>
        </div>
    );
